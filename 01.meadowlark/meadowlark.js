        ...
        if( !c.refreshing && Date.now() > c.refreshed + c.updateFrequency ){
            ...
            var promises = c.locations.map(function(loc){
                return Q.Promise(function(resolve){
                    var url = 'http://weather.news.qq.com/qresult.htm?acity' + loc.name + '.htm';
                    http.get(url, function(res){
                        ...
                        res.on('end', function(){
                            ...
                            loc.forecastUrl = 'http://weather.news.qq.com/qresult.htm?acity%E6%AD%A6%E6%B1%89.htm';//body.current_observation.forecast_url;
                            loc.iconUrl = 'http://mat1.gtimg.com/weather/2014gaiban/TB_duoyun_yejian.png';//body.current_observation.icon_url;
                            loc.weather = '多云';//body.current_observation.weather;
                            loc.temp = '12℃';//body.current_observation.temperature_string;
                            resolve();
                        });
                    });
                });
