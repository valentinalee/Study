...
function countKaoQin(slSheet,skSheet){
    ...
    const LegalHolidays = [
                            ...
                            '2017-01-01','2017-01-02','2017-01-27','2017-01-28','2017-01-29','2017-01-30','2017-01-31','2017-02-01','2017-02-02','2017-04-03','2017-04-04','2017-05-01','2017-05-29','2017-05-30','2017-10-01','2017-10-02','2017-10-03','2017-10-04','2017-10-05','2017-10-06',
                          ];//法定假日
    //判断工作日
    ...
    //错误名称纠正数据
    const errUserNames = [{from:'王月',to:'王玥'},{from:'陈文利',to:'陈文莉'},{from:'李建华',to:'李进华'}];
